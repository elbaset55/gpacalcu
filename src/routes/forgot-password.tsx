      ...
      <div style={{ width: "100%", maxWidth: 420 }}>
        ...
        <div style={{ background: "var(--gpa-card)", border: "1px solid var(--gpa-border)", borderRadius: 18, padding: 22 }}>
          <h1 style={{ margin: 0, fontSize: 20, fontWeight: 900, color: "var(--gpa-text)" }}>
            {ar ? "استعادة الوصول" : "Account Access"}
          </h1>
          <p style={{ fontSize: 13, color: "var(--gpa-text-faint)", margin: "10px 0 18px", lineHeight: 1.7 }}>
            {ar
              ? "Termly يستخدم تسجيل الدخول عبر Replit / Google. لاستعادة وصولك، استخدم نفس حساب Google الذي سجلت به."
              : "Termly uses Replit / Google login. To recover access, sign in using the same Google account you used to register."}
          </p>
          <a
            href="/api/auth/login"
            style={{
          ...
          >
            {ar ? "تسجيل الدخول بـ Google ←" : "Sign in with Google →"}
          </a>
