...
const T = {
  ar: {
    ...
    sub: "لاستعادة حسابك، سجّل الدخول مرة أخرى عبر Replit وسيتم التعرف عليك تلقائياً.",
    back: "← العودة لتسجيل الدخول",
    loginBtn: "تسجيل الدخول →",
  },
  en: {
    title: "Account Recovery",
    sub: "To recover your account, sign in again via Replit and you'll be recognized automatically.",
